<template>
  <div class="">
    <div class="flex items-center flex-col justify-center my-10">
      <!-- <h1 id="page-title" class="my-10 mb-4 font-fugaz font-bold uppercase text-7xl sm:text-8xl text-neutral-900 dark:text-neutral-100">Articles</h1> -->
      <!-- <HeaderSubtitle /> -->
    </div>
    <div class="flex justify-end items-center my-10">
      <!-- <NuxtLink to="/create/article"> -->
      <!--     <!-1- <span class="font-fragment text-3xl">New Review</span> -1-> -->
    ...
    <div class="flex flex-col items-center font-fragment" v-for="post in posts">
      <div
        id="post-block"
        class="text-left border-b-2 dark:border-neutral-700 w-full py-10"
      >
        <section
          id="post-inner-container"
        ...
        >
          ...
          <section id="post-image-container" class="w-4/12">
            <img
              ...
              v-bind:src="'https://app.ohko.org/assets/' + post.featured_image"
            />
          </section>
          ...
          <section id="post-content-container" class="py-5 w-8/12">
            <section id="post-details-container">
              ...
              <NuxtLink
                ...
                class="inline-block mt-3 mb-3 text-red transition-colors duration-200 font-fugaz"
                ><h3
                  id="post-title"
                  class="text-4xl font-fragment font-bold leading-10 text-black hover:text-stone-500 dark:text-white dark:hover:text-stone-500"
                >
                  {{ post.title }}
                </h3></NuxtLink
              >
            ...
            <section id="post-meta-container" class="flex gap-5">
              ...
              <div class="mt-5 flex flex-row flex-wrap gap-2">
                <span
                  class="font-fragment font-bold bg-neutral-300 text-neutral-900 text-lg px-2 rounded leading-10"
                >
                  Type: {{ post.category }}
                </span>
              </div>
              ...
              <div class="mt-5 flex flex-row flex-wrap gap-2">
                <section v-for="tag in post.tags" class="post-tags inline">
                  <span
                    class="font-fragment font-bold bg-infrared text-neutral-900 text-lg p-2 rounded leading-10"
                  >
                    #{{ tag }}
                  </span>
                </section>
            ...
            <section class="flex items-center justify-between">
              <!-- User Created -->
              <section
                id="post-player-container"
                class="flex gap-5 items-center mt-5"
              >
                <img
                  v-bind:src="
                    'https://app.ohko.org/assets/' + post.player_avatar
                  "
                  width="50"
                  class="rounded-full border p-1 dark:border-neutral-700"
                />
                <p
                  class="mb-2 font-fragment font-bold text-neutral-700 dark:text-neutral-300 text-md"
                >
                  @{{ post.player }}
                </p>
              </section>
              ...
              <section id="post-hearts-container" class="flex justify-end mt-4">
                <section class="font-fragment flex flex-col items-center">
                  <Icon
                    ...
                    class="text-infrared"
                  />
                  <span class="text-infrared text-lg font-VCR">{{
                    post.hearts.length
                  }}</span>
                </section>
              </section>
